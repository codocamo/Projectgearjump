var offset_y = 100
 ...
 draw_text_ext_color(260, 350-offset_y,string_hash_to_newline("Class: Asteroid???##Hazzards: NONE##Atmosphere: NONE##Number of Exits: 2##Fun Fact: Its not fun"), 25, 1200, c_white, c_white, c_white, c_white, 1); 
...
draw_text_ext_color(camera_get_view_width(view_camera[0])/2, 620-offset_y,string_hash_to_newline("([UP]/[DOWN] keys = select a level)  ([W] key = start)"), 25, camera_get_view_width(view_camera[0]), c_yellow, c_yellow, c_yellow, c_yellow, 1); 
