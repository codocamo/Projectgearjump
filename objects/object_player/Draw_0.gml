...
if(object_giftext.help_chkpt_ftr > 6)
{
...
else if(object_giftext.help_chkpt_ftr > 5)
{
...
else if(object_giftext.help_chkpt_ftr > 4)
{
...
else if((mid_jump == false) && (object_giftext.help_chkpt_ftr < 5)){
...
else if((mid_jump == true) && (object_giftext.help_chkpt_ftr < 5)){
