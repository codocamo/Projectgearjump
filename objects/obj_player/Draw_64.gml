...
if(pkupslidestate[0] && !inslide && slidehelp)
{
	...
	if(endingcounter == 2)
	{
		pickuphelptxtx += obj_player.velocity[0]
		draw_text_ext_transformed_color(pickuphelptxtx,450, "Press S" ,20, 200, 1, 1, 0, c_yellow,c_yellow,c_yellow,c_yellow, 1 )
	}
...
else if (inslide && slidehelp)
{
	...
	{
		pickuphelptxtx += obj_player.velocity[0]
		draw_text_ext_transformed_color(pickuphelptxtx - 30,450, "Good!" ,20, 200, 1, 1, 0, c_yellow,c_yellow,c_yellow,c_yellow, 1 )
	}
	else if(endingcounter != 3)
	{
...
//sprite pick up slide indicator
