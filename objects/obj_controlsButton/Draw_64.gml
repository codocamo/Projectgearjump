...
if(showcontrols)
{
	...
	draw_text_ext_transformed_color(obj_optionsButton.controlsbtnpos_image[0] - 180, obj_optionsButton.controlsbtnpos_image[1] - 130,string_hash_to_newline("[W]/[Space]    =    Jump#[I]    =    Jump gear 1#[O]    =    Jump gear 2#[P]    =    Jump gear 3#[D]    =    Interact#[A]    =    Use slide powerup#[S]    =    Use faze powerup"), 40, camera_get_view_width(view_camera[0]), 1.2, 1.2, 0,c_yellow, c_yellow, c_yellow, c_yellow, obj_optionsButton.alpha); 
