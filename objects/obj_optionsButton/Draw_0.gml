...
draw_sprite_ext(spr_optionbutton, -1, x, y, 1, 1, rotate, c_white,1)
...
{ 
		...
		if (!instance_exists(obj_trashButton)) {instance_create_depth((mutebtnx * 3) - 20, mutebtny, 0, obj_trashButton);}
}
